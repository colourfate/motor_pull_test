...
Use ina226 to measure power supply voltage and current. SDA of i2c is assigned to GPIO 4, and scl is assigned to GPIO 5.
3. output
...
is sd1306, which is completed by olikraus/U8g2, Sharing i2c interface with ina226.
